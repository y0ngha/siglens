...
- [SEO_RECOVERY_2026_09.md](./architecture/SEO_RECOVERY_2026_09.md) — 2026-07 노출 절벽 재감사: 원인 판정(품질 강등), 배제된 가설, 회복 전략 A/B/C와 측정 지표, §9 2026-09-17 운영 크롤·렌더 감사(UA별 본문·하이드레이션·템플릿 탭·sitemap noindex)
