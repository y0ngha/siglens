...
버킷명(`siglens-isr-cache`)은 다음 3곳에서 동기화되어야 한다:
- `infra/aws/12-isr-cache.sh`
- `infra/aws/deploy.sh` / `.github/workflows/deploy.yml`
- `infra/aws/iam/ec2-role-policy.json` (`Resource` ARN)
