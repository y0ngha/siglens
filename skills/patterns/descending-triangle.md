...
- **keyPrices**: Include the horizontal support level, the current descending trendline value, the projected apex price and approximate bar, and the breakdown target price if support is broken.
