...
LTDATA="{\"ImageId\":\"$AMI\",\"InstanceType\":\"$INSTANCE_TYPE\",\"IamInstanceProfile\":{\"Name\":\"$EC2_ROLE\"},\"SecurityGroupIds\":[\"$EC2_SG\"],\"BlockDeviceMappings\":[{\"DeviceName\":\"/dev/xvda\",\"Ebs\":{\"VolumeSize\":50,\"VolumeType\":\"gp3\",\"DeleteOnTermination\":true}}],\"UserData\":\"$UD\",\"TagSpecifications\":[{\"ResourceType\":\"instance\",\"Tags\":[{\"Key\":\"Name\",\"Value\":\"siglens\"}]}]}"
