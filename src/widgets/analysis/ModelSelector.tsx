        ...
        <div className={cn('flex flex-row items-center gap-3', className)}>
            ...
            <div className="relative min-w-0 flex-1">
                <button
                    ...
                    className={cn(
                        'border-secondary-700 hover:bg-secondary-700/30 focus-visible:ring-primary-500 flex min-h-11 w-full touch-manipulation items-center justify-between rounded-lg border px-3 py-2 transition-colors focus-visible:ring-1 focus-visible:outline-none',
