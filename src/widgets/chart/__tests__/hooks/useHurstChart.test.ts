...
const EMPTY_INDICATORS = { hurst: [] } as unknown as IndicatorResult;

const FILLED_INDICATORS = {
    hurst: [null, null, 0.45, 0.5, 0.62],
...
describe('useHurstChart', () => {
    ...
    it('creates Hurst series when visible with chart', () => {
        renderHook(() =>
            useHurstChart({
                chartRef: makeChartRef(makeChart()),
                bars: FAKE_BARS,
