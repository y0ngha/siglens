...
describe('CongressTrendSummaryError', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
    ...
    it('falls back to the generic congress message for non-Error values', () => {
        // Congress generic fallback differs from financials:
        //   financials → '분석 중 오류가 발생했습니다.'
        //   congress   → '동향 해석 중 오류가 발생했습니다.'
        mockGetFmpMsg.mockReturnValue(null);
