...
export function StrikeBarTooltip({
    ...
    return (
        <div
            ...
            className="pointer-events-none absolute top-[var(--tooltip-y)] left-[var(--tooltip-x)] z-10 min-w-[var(--tooltip-min-w)] -translate-x-1/2 -translate-y-full rounded-lg border border-border-control bg-secondary-900/95 px-3 py-2 text-xs text-secondary-100 shadow-lg backdrop-blur"
            style={
