        ...
        mainEntity: [
            {
                ...
                acceptedAnswer: {
                    '@type': 'Answer',
                    text: '미국 주식과 비트코인·이더리움 같은 암호화폐 티커를 입력하면 차트(보조지표와 캔들 패턴, 지지선과 저항선), 실적과 밸류에이션, 최근 뉴스 흐름, 옵션 시장 데이터, 그리고 단기 매수 분위기(공포 탐욕 지수)까지 각각 정리하고 이걸 묶은 종합 결론까지 보여주는 무료 웹 서비스입니다. 회원가입 없이 바로 이용할 수 있습니다.',
                },
            },
            {
                '@type': 'Question',
