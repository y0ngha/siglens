...
vi.mock('@/shared/lib/legal', () => ({
    ...
    privacyDescription: () => 'privacy desc',
    privacyFullTitle: () => 'Privacy Full Title',
...
import { generateMetadata } from '@/app/[locale]/privacy/page';

const metadataFor = (locale = 'ko') =>
    generateMetadata({ params: Promise.resolve({ locale }) });

describe('Privacy page', () => {
    it('exports metadata with privacy title', async () => {
