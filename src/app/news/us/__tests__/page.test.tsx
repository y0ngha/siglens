...
vi.mock('@/app/news/_lib/categoryPreviews', () => ({
...
import UsNewsHubPage, {
    generateMetadata,
    revalidate,
} from '@/app/news/us/page';
import { fetchCategoryPreviews } from '@/app/news/_lib/categoryPreviews';
...
describe('/news/us hub', () => {
    ...
    it('places itself under the top hub in the breadcrumb', async () => {
        const { container } = render(await UsNewsHubPage());
