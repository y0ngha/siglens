...
describe('/backtesting SSR output', () => {
    it('renders every real case ticker in the effect-free first render pass', () => {
        const html = renderToStaticMarkup(<BacktestingPage />);
    ...
    it('does not filter the list based on the current URL before hydration', () => {
