            ...
            >
                <PolicySection id="intro" title="1. 총칙">
                    <p>
                        ...
                        제공하는 무료 웹 서비스입니다. 운영자는 회원가입이나
                        로그인 없이 이용할 수 있는 서비스 구조를 채택하여,
                        이용자의 개인을 식별할 수 있는 정보의 수집을 최소화하고
                        있습니다.
                    </p>
                    <p>
                        본 개인정보처리방침은 운영자가 제공하는 웹 서비스(이하
                        &quot;서비스&quot;)에 적용되며, 이용자가 서비스를
                        이용함에 있어 수집되는 정보와 그 처리에 관한 사항을
                        설명합니다.
                    </p>
                </PolicySection>
                ...
                >
                    <p>
                        운영자는 회원가입 절차를 운영하지 않으며, 이용자 식별을
                        위한 이름·이메일·전화번호 등
                        <strong className="text-secondary-200">
                            &nbsp;개인정보를 직접 수집하지 않습니다
                        </strong>
                        . 다만, 서비스 운영 및 보안을 위해 아래와 같은 정보가
                        자동으로 생성·수집될 수 있습니다.
                    </p>
                    ...
                    <p>
                        수집 방법: 이용자가 서비스에 접속하거나 기능을 사용할 때
                        자동으로 수집되며, 오류 제보는 이용자 본인이 능동적으로
                        제출하는 경우에 한해 수집됩니다.
                    </p>
                </PolicySection>
                ...
                >
                    ...
                    <ul className="list-disc space-y-1.5 pl-5">
                        ...
                        <li>
                            보안 및 부정 이용 방지: 비정상적 접근의 탐지 및 차단
                        </li>
                ...
                <PolicySection id="cookies" title="7. 쿠키 및 로컬 스토리지">
                    ...
                    <p>
                        ...
                        저장된 데이터를 언제든지 삭제할 수 있습니다. 다만, 쿠키
                        저장을 거부할 경우 일부 서비스 기능 이용에 제약이 발생할
                        수 있습니다.
                    </p>
                </PolicySection>
                ...
                <PolicySection id="rights" title="8. 이용자의 권리와 행사 방법">
                    <p>
                        ...
                        권리가 있습니다. 다만, 운영자는 회원가입 절차를 운영하지
                        않으므로 개인을 식별할 수 있는 정보의 수집 자체를
                        최소화하고 있으며, 별도로 저장된 개인정보가 없는 경우 본
                        권리의 행사 대상이 되는 정보가 존재하지 않을 수
                        있습니다.
                    </p>
                    <p>
                        이용자가 오류 제보를 통해 제공한 문의 내용에 대하여 열람
                        또는 삭제를 원하시는 경우, 아래 &quot;10. 개인정보
                        보호책임자 및 문의&quot;의 연락처로 요청하실 수
                        있습니다.
                    </p>
                </PolicySection>
