    ...
    return (
        <div className="relative min-w-0 flex-1">
            <input
                ...
                aria-label={ariaLabel}
                aria-describedby={ariaDescribedby}
                className="h-10 w-full rounded-md border border-secondary-700 bg-secondary-950 px-3 pr-10 font-mono text-sm text-secondary-50 placeholder:text-secondary-500 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/40 focus:outline-none"
            />
            <button
                type="button"
