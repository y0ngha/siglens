                ...
                >
                    ...
                    <div role="none" className="mt-1">
                        <Link
                            ...
                            role="menuitem"
                            onClick={close}
                            className="text-secondary-200 hover:bg-secondary-800 flex w-full items-center rounded px-3 py-2 text-left text-sm transition-colors focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
                        >
                            계정 설정
                        </Link>
                        <LogoutButton />
