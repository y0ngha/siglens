...
export function AuthCardShell({
    ...
    return (
        <main className="relative flex min-h-[calc(100dvh-3.5rem)] items-center justify-center overflow-hidden bg-slate-950 px-4 py-12">
            ...
            <section className="ring-secondary-800 relative w-full max-w-md rounded-2xl bg-slate-900/80 p-8 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.7)] ring-1 backdrop-blur-xl motion-safe:animate-[fade-up_220ms_ease-out]">
