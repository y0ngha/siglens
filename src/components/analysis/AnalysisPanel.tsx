...
const SIGNAL_TYPE_LABEL: Record<SignalType, string> = {
    ...
    stochastic_overbought: '스토캐스틱 과매수',
    stochastic_oversold: '스토캐스틱 과매도',
    stoch_rsi_overbought: 'StochRSI 과매수',
    stoch_rsi_oversold: 'StochRSI 과매도',
    cci_overbought: 'CCI 과매수',
    cci_oversold: 'CCI 과매도',
    ichimoku_bullish: '일목 상승',
    ichimoku_bearish: '일목 하락',
    ichimoku_cloud_breakout: '일목 구름 돌파',
    volume_profile_poc_support: 'VP POC 지지',
    volume_profile_poc_resistance: 'VP POC 저항',
    pattern: '패턴',
    skill: '스킬',
};
