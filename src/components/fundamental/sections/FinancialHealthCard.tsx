        ...
        >
            ...
            <div>
                <HealthMetric
                    ...
                    tooltip={
                        <>
                            ...
                            <p>0.5 이하면 양호, 0.7 이상이면 부채 부담이 큰 편이에요.</p>
                ...
                <HealthMetric
                    ...
                    tooltip={
                        <>
                            <p>1년 안에 갚아야 할 빚을, 1년 안에 현금화할 수 있는 자산으로 갚을 수 있는지 보여주는 값이에요.</p>
                            <p>1.5 이상이면 단기 자금 사정이 양호해요.</p>
                            <p>1 미만이면 단기 자금난 위험이 있다는 뜻이에요.</p>
                        </>
                    }
                />
                <HealthMetric
                    ...
                    tooltip={
                        <>
                            <p>본업으로 실제로 들어온 현금이 얼마인지 보여주는 값이에요.</p>
                            <p>양수(+)면 본업으로 돈을 잘 벌고 있다는 뜻이에요.</p>
                ...
                <HealthMetric
                    ...
                    tooltip={
                        <>
                            ...
                            <p>2.99 이상이면 안전, 1.81~2.99는 경계 구간이에요.</p>
                ...
                <HealthMetric
                    ...
                    tooltip={
                        <>
                            <p>9가지 재무 기준을 점수로 합산해 재무 건강 상태를 평가하는 값이에요(0~9점).</p>
