        ...
        >
            ...
            <div>
                <MetricRow
                    ...
                    tooltip={
                        <>
                            <p>현재 주가가 1년치 이익의 몇 배인지 보여주는 값이에요.</p>
                ...
                <MetricRow
                    ...
                    tooltip={
                        <>
                            ...
                            <p>아직 이익이 적은 성장주나 적자 기업을 평가할 때 자주 써요.</p>
                            <p>보통 1 이하면 매출 대비 저평가, 5 이상이면 고평가로 봐요.</p>
                        </>
                    }
                />
                <MetricRow
                    ...
                    tooltip={
                        <>
                            <p>주가가 회사가 가진 순자산의 몇 배인지 보여주는 값이에요.</p>
                            <p>1 미만이면 회사 자산보다 싸게 거래되고 있다는 뜻이에요.</p>
                            <p>1 이상이면 자산 가치 이상으로 평가받고 있다는 뜻이에요.</p>
                        </>
                    }
                />
                <MetricRow
                    ...
                    tooltip={
                        <>
                            ...
                            <p>1 미만이면 성장성 대비 저평가, 1 이상이면 성장 대비 고평가예요.</p>
                        </>
                    }
                />
                <MetricRow
                    ...
                    tooltip={
                        <>
                            <p>빚까지 포함한 기업 전체 가치를 영업이익(감가상각 전 기준)으로 나눈 값이에요.</p>
                            <p>인수·합병이나 기업 간 비교에서 자주 쓰고, 낮을수록 저렴하다고 봐요.</p>
                        </>
                    }
                />
                <MetricRow
                    ...
                    tooltip={
                        <>
                            <p>회사가 1년간 번 순이익을 1주당 얼마 벌었는지로 환산한 값이에요.</p>
                            <p>클수록 주식 1주가 더 많은 이익을 만들어내고 있다는 뜻이에요.</p>
                        </>
                    }
                />
            </div>
