...
export const POPULAR_TICKERS = [
    ...
    //
    //    2026-09-17 가지치기: A·C의 15종(ESMT·SOI·CTK·DYFN·TLIIX·CLAA·PSMC·HVBC·
    //    BSTG·ASSF·GTS·ENTF·SRYB·DIRV·SWAR)을 뺐다. 08-24부터 3주 넘게 봉이 0개였고
    //    대부분 인수·청산·상장폐지로 돌아올 수 없는 티커다. 런타임 게이트(`hasPriceData`)가
    //    차트는 noindex로 막았지만 `/fundamental`은 옛 프로필로 색인되고, sitemap에는
    //    noindex 탭 60여 개가 실리고, 프리웜은 매일 밤 이들에 LLM을 돌렸다.
