...
export function SymbolTabsSkeleton() {
    return (
        ...
        >
            {/* 실제 `SymbolTabs`와 **같은 래퍼**를 둔다. 한쪽만 폭 규약이 다르면
                탭이 들어오는 순간 가로로 튄다. `min-h-11`도 실제 탭 링크와 같은
                값이다 — 알약만 두면 40px이라 탭이 들어올 때 세로로도 밀린다. */}
            <div className="-mb-px flex min-h-11 min-w-max items-center">
