...
describe('DrizzleLongTailTickerSource', () => {
    it('counts distinct long-tail symbols and excludes popular tickers', async () => {
        ...
        expect(sql).toContain('where "korean_tickers"."symbol" not in');
    ...
    it('loads page 3 with stable distinct ordering and pagination params', async () => {
