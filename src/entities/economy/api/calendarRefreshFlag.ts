 ...
 */
const ingestionFlag = createRedisFlag<CalendarCountry>(
...
export const isCalendarRecentlyFetched = ingestionFlag.isSet;

/** "최근 fetch함" 마킹 — Redis 실패 시 noop. */
export const markCalendarFetched = ingestionFlag.mark;
