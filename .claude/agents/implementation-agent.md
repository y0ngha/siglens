...
description: 이슈 번호가 주어진 구현 요청 전담. "이슈 #12 구현해줘", "#12 구현해줘", "이슈 #12 작업해줘", "#12 작업해줘", "이슈 #12 확인하고 구현해줘", "#12 이슈 확인하고 구현해줘"  등에 사용.
...
`.claude/agent-memory/implementation-agent/MEMORY.md`를 읽고 인덱스에 있는 모든 파일을 로딩한다.
...
**만약 이슈를 찾을 수 없다면, 이슈를 찾을 수 없음을 알리고 끝내주세요.**
